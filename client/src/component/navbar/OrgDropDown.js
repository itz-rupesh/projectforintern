...
const OrgDropDown = () => {
    ...
    function renderRow(props) {
        ...
        return (<>{
            searchResult.length !== 0 ? searchResult.map((val, index) => {
                return <ListItem key={index} component="div" onClick={() => { dispatchh({ type: 'USER', payload: val._id }); navigate('/organization/orgfeed/userprofile'); handleCloseList(); }} className="p-1" >
    ...
    const onSearch = async (e) => {
        ...
        console.log(keyword);
        await axios.get(`/search/user/${keyword}`, { cancelToken: cancelToken.token }).then((res) => {
    ...
    return (
        <React.Fragment>
                ...
                <Search>
                    ...
                    />
                    {
                        openList && <FixedSizeList
                            ...
                            // width={360}
                            // zIndex={99}
                            itemSize={searchResult.length === 0 ? 1 : searchResult.length}
            ...
            >
                <MenuItem onClick={() => navigate('/organization/dashboard')}>
                    {
                        state?.image !== "" ? <Avatar sx={{ width: 35, height: 35 }} src={state.image} alt="A" /> :
                            <Avatar sx={{ width: 35, height: 35 }} />
                    } Profile
                ...
                <MenuItem onClick={() => navigate('/organization/orgfeed')}>
                    <ListItemIcon >
                        <Dashboard fontSize="small" />
                    </ListItemIcon>
                    Feed
                </MenuItem>
                <MenuItem onClick={() => navigate('/organization/chat')}>
                    <ListItemIcon >
                        <ChatBubbleIcon fontSize="small" />
                    </ListItemIcon>
                    Chat box
                </MenuItem>
                <MenuItem onClick={() => navigate('/organization/setup')}>
                    <ListItemIcon>
