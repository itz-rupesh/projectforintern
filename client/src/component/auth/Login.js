...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        axios.post('/account/login', formValues)
            .then(res => {
                    ...
                    <div className="col-12 col-md-8 col-lg-6 col-xl-5">
                        <div className="card bg-dark text-white" style={{ borderRadius: '1rem' }}>
                            <div className="card-body p-5 text-center">
                                ...
                                <div>
                                    <p className="mb-0">Don't have an account? <Link to="/login/signup" className="text-white-50 fw-bold">Sign Up</Link></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
const SignUp = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        cogoToast.loading(" Processing !!");
        axios.post('/account/signup', formValues)
            .then(res => {
                cogoToast.success(res.data.message);
                setMessage({ text: res.data.message, color: "green" });
                dispatch({ type: "USER", payload: { image: res.data.image, name: res.data.name } });
                    ...
                    <div className="col-12 col-md-8 col-lg-6 col-xl-5">
                        <div className="card bg-dark text-white" style={{ borderRadius: '1rem' }}>
                            <div className="card-body p-5 text-center">
                                ...
                                <div>
                                    <p className="mb-0">Already have an account? <Link to="/login/signin" className="text-white-50 fw-bold">Sign In</Link></p>
                                </div>
                            </div>
                        </div>
                    </div>
